...
export function DescribeProject({ Describe,Photo,Mob }: Pick<Project, "Describe"|"Photo">&{Mob?:boolean}) {
  return (
    <div className="flex flex-row justify-center items-center mb-2">
        ...
        <div className={`lg:w-5/10 md:w-8/10 w-full lg:pb-8 sm:pb-2 pb-0 md:px-8 sm:px-2 px-0 p-8 lg:h-[400px] mg:h-[350px] sm:h-[300px] h-[250px] relative bg-bg rounded-xl flex flex-col justify-center items-center
         @container`} >
