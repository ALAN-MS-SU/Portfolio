...
>) {
  return (
    <div className="flex flex-row justify-center items-center mb-5 w-full">
      <div
        className={
          "flex 2xl:flex-row flex-col mx-2 justify-center items-center gap-2 max-w-400 w-full"
        }
      >
          ...
          <div className="grid @md:grid-cols-2 grid-cols-1 justify-items-center w-full h-full @md:py-0 py-3">
            ...
            <p className="@2xl:text-lg @lg:text-[100%] text-[80%] font-bold flex flex-col justify-center items-center text-text-primary">
              ...
              <span>
                {Team ? (
                  <IoPeopleSharp
                    className={"@2xl:text-2xl @lg:text-xl text-lg text-yes"}
                  />
                ) : (
                  <IoPersonSharp
                    className={"@2xl:text-2xl @lg:text-xl text-lg text-yes"}
            ...
            <p className="@2xl:text-lg @lg:text-[100%] text-[80%] font-bold flex flex-col justify-center items-center text-text-primary">
              ...
              <span>
                {API ? (
                  ...
                  <BiSolidDislike
                    className={"@2xl:text-2xl @lg:text-xl text-lg text-no"}
                  />
                )}
              </span>
            </p>
        ...
        <div className="2xl:w-1/3 md:w-8/10 w-full md:px-8 sm:px-4 px-2 p-8 2xl:h-[315px] h-auto relative bg-bg rounded-xl @container">
          ...
          <ul className={"mt-5 ml-3.5 list-disc space-y-2"}>
            {Features.map((Feature, index) => {
              return (
                <li
                  className={`${Features.length <= 7 ? "@2xl:text-[100%] @md:text-sm @sm:text-[90%] text-[80%]" : "@2xl:text-[90%] @md:text-[85%] @sm:text-[80%] text-[70%]"} 
            text-text-primary`}
                  key={index}
                >
                  {Feature}
